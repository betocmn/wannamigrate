...
# Migration functions
#########################
def translate_topics_to_pt( apps, schema_editor ):
    """
    ...
    for topic in topics:
        ...
        for x in itertools.count(1):
            if not TopicTranslation.objects.filter( slug = translated_slug ).exists():
                break
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('qa', '0006_auto_20150522_0545'),
    ]

    operations = [
        migrations.RunPython( translate_topics_to_pt ),
    ]