...
from wannamigrate.core.signals import generate_slug_from_title
...
post_delete.connect(pre_delete_delete_callback, sender=Section)
pre_save.connect(pre_save_delete_callback, sender=Section)
pre_save.connect(generate_slug_from_title, sender=Chapter)
