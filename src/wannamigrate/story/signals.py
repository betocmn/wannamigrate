...
post_delete.connect(pre_delete_delete_callback, sender=Post)
pre_save.connect(pre_save_delete_callback, sender=Post)
pre_save.connect(generate_slug_from_title, sender=Post)
